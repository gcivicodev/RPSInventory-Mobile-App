...
class ViewSyncAlmacen extends ConsumerStatefulWidget {
  const ViewSyncAlmacen({super.key});
  static String path = '/syncAlmacen';

  @override
  ConsumerState<ViewSyncAlmacen> createState() => _ViewSyncAlmacenState();
}
  ...
  Widget _buildDownloadingView(SyncState syncState) {
    return Column(
      ...
      children: [
        ...
        _buildSyncItem(
          label: 'Sincronizando Productos de Almacén',
